...
namespace Miscalculation.Motion.Card
{
    ...
    /// </summary>
    [Serializable]
    public sealed class CardMotionProfile
    {
        public const string CurrentVersion = "1.0.3";
        public const string CurrentAlgorithm = "card-deal-v1.0.3-contact-friction-targeted-sequence";
        public int schemaVersion = 1;
        public string motionVersion = CurrentVersion;
        public string algorithmVersion = CurrentAlgorithm;
        public string profileId = "card.battle.default";
        ...
        public void ClampInPlace()
        {
            ...
            land.slidePx = Mathf.Clamp(land.slidePx, 0f, 140f);
            ...
            motionVersion = CurrentVersion;
            algorithmVersion = CurrentAlgorithm;
        }

        public static CardMotionProfile FromJson(string json)
        {
            var value = JsonUtility.FromJson<CardMotionProfile>(json);
            if (value == null) throw new ArgumentException("Invalid CardMotionProfile JSON", nameof(json));
            value.ClampInPlace();
            return value;
        }
    }
