//基础零件主数值提高30%；自己每损失10%生命值，额外提高10%，最高提高到130%。
public class AdvancedEffect3021 : BaseEffectHandleObject
{
    ...
    private readonly int _id = AdvancedEffectHandleMgr.advancedEffectId3021;
    ...
    protected override void _effect(IBaseEffectHandlePara para) {
        ...
        if (para.getAttackUser().getMaxBlood() * this._logicValue > para.getExtralValue())
        {
            IBaseEffectValue baseEffectValue = data.getBaseEffectValue(BaseEffectType.baseDataUp);
