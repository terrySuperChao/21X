...
public class AdvancedEffect3904 : BaseEffectHandleObject
{
    ...
    private readonly int _id = AdvancedEffectHandleMgr.advancedEffectId3904;
    ...
    protected override void _handle(ITriggerHandlePara para)
    {
        ...
        GameMagicMgr.Instance.handle(para.getAttackUser(), para.getDefenseUser(), this._initMagic);
    }
}
