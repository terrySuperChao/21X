//接下来的3回合每回合回复 %s 点法力
public class BaseEffect2033 : BaseEffectHandleObject
{
    private readonly int _initValue = 1;
    private readonly int _stepValue = 1;
    private readonly int _maxValue = 3;
    private readonly int _id = BaseEffectHandleMgr.baseEffectId2023;
    ...
    {
        if (para.getEffectType() != AdvancedEffectType.roundStartAddMagic)
        {
            return;
        }
