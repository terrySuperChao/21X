//下次转化红桃属性，治疗量的 %s% 额外转化为法力值，最多叠加5层
public class BaseEffect2024 : BaseEffectHandleObject
{
    private readonly int _initValue = 1;
    private readonly int _stepValue = 1;
    private readonly int _maxValue = 5;
    private readonly int _id = BaseEffectHandleMgr.baseEffectId2024;
    ...
    protected override void _handle(ITriggerHandlePara para)
    {
        ...
        IBaseEffectValue baseEffectValue2 = data.getBaseEffectValue(BaseEffectType.healToMP);
        if (!data.isState())
        {
            data.setState(1);
