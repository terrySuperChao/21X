...
public class LangMgr : Singleton<LangMgr>
{
    ...
    public Dictionary<string, string> getLanguageMap() {
        if (this._languageMap == null) {
            ...
            this._languageMap.Add(LanguageList.zh_CN, "中文简体");
            this._languageMap.Add(LanguageList.zh_TW, "中文繁体");
            this._languageMap.Add(LanguageList.en_US, "English");
            //this._languageMap.Add("葡萄牙语");
            //this._languageMap.Add("德语");
            //this._languageMap.Add("法语");
            //this._languageMap.Add("西班牙语");
            //this._languageMap.Add("日语");
            //this._languageMap.Add("韩语");
        }
